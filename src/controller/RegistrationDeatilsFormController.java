...
public class RegistrationDeatilsFormController {
    ...
    public void stTableOnMouseClick(MouseEvent mouseEvent) {
        try {
            StudentTM selectItem = tblRegister.getSelectionModel().getSelectedItem();
            String regNumber = selectItem.getRegNumber();
            ObservableList<ProgrammeTM>studentProgrammes = programmeBO.getStudentPrograms(regNumber);
            tblProgramme.setItems(studentProgrammes);
